...
import { sampleWithRequiredData } from '../detail-facture.test-samples';
...
describe('DetailFacture Management Component', () => {
  let comp: DetailFactureComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [DetailFactureComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(DetailFactureComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.detailFactures()[0]).toEqual(expect.objectContaining({ id: 17963 }));
  });

  describe('trackId', () => {
    it('should forward to detailFactureService', () => {
      const entity = { id: 17963 };
      jest.spyOn(service, 'getDetailFactureIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDetailFactureIdentifier).toHaveBeenCalledWith(entity);

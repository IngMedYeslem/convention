...
import { sampleWithRequiredData } from '../detail-convention.test-samples';
...
describe('DetailConvention Management Component', () => {
  let comp: DetailConventionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [DetailConventionComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(DetailConventionComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.detailConventions()[0]).toEqual(expect.objectContaining({ id: 29255 }));
  });

  describe('trackId', () => {
    it('should forward to detailConventionService', () => {
      const entity = { id: 29255 };
      jest.spyOn(service, 'getDetailConventionIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDetailConventionIdentifier).toHaveBeenCalledWith(entity);
